...
class ViewController: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    self.fetchCovidOverview(completionHaneler: { [weak self] result in
  ...
  func fetchCovidOverview(
    completionHaneler: @escaping (Result<CityCovidOverview, Error>) -> Void
  ) {
    let url = "https://api.corona-19.kr/korea/country/new/"
    let param = [
      "serviceKey": "U49VLoxSIEAm3DqJvKtjRhOYyMpHu5rfQ"
    ]
      ...
      .response(completionHandler: { response in
        ...
        case let .success(data):
          do {
            ...
            completionHaneler(.success(result))
          } catch {
            completionHaneler(.failure(error))
          }
